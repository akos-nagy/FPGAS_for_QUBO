...
In general, the implementation of $S_t \( \beta \)$ is case specific. In the case of QUBO problems, we can use constructions of \Cref{sec:quad,sec:xor_basis}, to get an oracle, $U_t$ on $n + 1$ qubits, such that for all $x \in \Z_2^n$ and $y \in \Z_2$, we have
\begin{equation}
